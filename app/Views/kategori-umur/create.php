                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/master-data/kategori-umur/store" method="post">
                                <?= csrf_field(); ?>
                                <div class="form-group">
                                    <label for="kategori_umur">Kategori Umur</label>
                                    <input type="text" class="form-control <?= $validation && $validation->hasError('kategori_umur') ? 'is-invalid' : '' ?>" id="kategori_umur" name="kategori_umur" placeholder="Kategori umur" value="<?= old('kategori_umur') ?>">
