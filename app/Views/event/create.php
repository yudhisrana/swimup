                        ...
                        <div class="card-body">
                            ...
                            <form action="/menu/event/store" method="post">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="kategori_umur" id="kategori_umur" class="form-control <?= $validation && $validation->hasError('kategori_umur') ? 'is-invalid' : '' ?>">
                                            ...
                                            <?php foreach ($kategori_umur as $kategoriUmur) { ?>
                                                <option value="<?= $kategoriUmur->id ?>" <?= old('kategori_umur') == $kategoriUmur->id ? 'selected' : '' ?>><?= $kategoriUmur->name ?></option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="gaya_renang" id="gaya_renang" class="form-control <?= $validation && $validation->hasError('gaya_renang') ? 'is-invalid' : '' ?>">
                                            ...
                                            <?php foreach ($gaya_renang as $gayaRenang) { ?>
                                                <option value="<?= $gayaRenang->id ?>" <?= old('gaya_renang') == $gayaRenang->id ? 'selected' : '' ?>><?= $gayaRenang->name ?></option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="jarak_renang" id="jarak_renang" class="form-control <?= $validation && $validation->hasError('jarak_renang') ? 'is-invalid' : '' ?>">
                                            ...
                                            <?php foreach ($jarak_renang as $jarakRenang) { ?>
                                                <option value="<?= $jarakRenang->id ?>" <?= old('jarak_renang') == $jarakRenang->id ? 'selected' : '' ?>><?= $jarakRenang->name ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group date" id="tanggal_event" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input <?= $validation && $validation->hasError('tanggal_event') ? 'is-invalid' : '' ?>" data-target="#tanggal_event" name="tanggal_event" placeholder="06/17/2025 00:00 AM" value="<?= old('tanggal_event') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" rows="3" class="form-control <?= $validation && $validation->hasError('deskripsi') ? 'is-invalid' : '' ?>"><?= old('deskripsi') ?></textarea>
