                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= '/master-data/gaya-renang/update/' . $gaya_renang->id; ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="form-group">
                                    <label for="gaya_renang">Gaya Renang</label>
                                    <input type="text" class="form-control <?= $validation && $validation->hasError('gaya_renang') ? 'is-invalid' : '' ?>" id="gaya_renang" name="gaya_renang" placeholder="Nama gaya renang" value="<?= old('gaya_renang', $gaya_renang->name) ?>">
