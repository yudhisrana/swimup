                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="/master-data/jarak-renang/create" type="button" class="btn btn-info">
                        ...
                        <div class="card-body">
                            <table
                                ...
                                <tbody>
                                    <?php foreach ($jarak_renang as $key => $value) { ?>
                                        <tr>
                                            <td><?= $key + 1; ?></td>
                                            <td><?= $value->name; ?></td>
                                            ...
                                            <td>
                                                <a href="<?= '/master-data/jarak-renang/edit/' . $value->id ?>" type="button" class="btn btn-warning">
...
<script>
    ...
    $(function() {
        $('.btn-delete').click(function() {
            ...
            url = baseUrl + 'master-data/jarak-renang/delete/' + id;
            method = 'POST';
